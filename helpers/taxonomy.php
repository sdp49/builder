...
class PL_Taxonomy_Helper {
	...
	public static function register_taxonomies () {
		...
		register_taxonomy('street', array('property'), array('hierarchical' => TRUE,'label' => __('Streets'), 'public' => TRUE,'show_ui' => false,'query_var' => true,'rewrite' => array('with_front' => false, 'hierarchical' => false) ) );
		...
		register_taxonomy('half-baths', 'property', array('hierarchical' => TRUE,'label' => __('Half-baths'), 'public' => TRUE,'show_ui' => false,'query_var' => true,'rewrite' => true ) );
		register_taxonomy('mlsid', 'property', array('hierarchical' => TRUE,'label' => __('MLS ID'), 'public' => TRUE,'show_ui' => false,'query_var' => true,'rewrite' => true ) );
	}
