<?php if (get_current_user_id()): ?>
	<div>
	  <a target="_blank" class="pls_save_search" href="#pl_saved_search_register_form" style="font-size: 16px; color: white; margin-top: 20px; font-weight: bold">Save this Search</a>
