...
'title' => 'Location-filtered Sales Template',
...
<div class="pl_form pl_col-124">
    ...
    <div class="pl_form-item pl_col hide-mobile no-search">
...
'description' => "The Location-filtered Sales Template assumes that you are filtering the shortcode with location filters. The form options for searching include beds, baths, price, sqft, and property type. The price ranges are in Sales ranges.",
