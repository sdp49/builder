...
'title' => 'Property Type-filtered Sales Template',
...
<div class="pl_form pl_col-124">
    ...
    <div class="pl_form-item hide-mobile pl_col">
...
'description' => "The Property Type-filtered Sales Template assumes that you are filtering the shortcode with property type and/or custom amenity (ie. 'waterfront') filters. The form options for searching include neighborhoods, cities, zip, beds, baths, price, and sqft. The price ranges are in Sales ranges.",
