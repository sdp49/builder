			...
			<div class="search_filter_content">
				...
				<div class="global_filter_col form_item">
					<form action="" id="global_filter_form">
						<?php // PL_Form::generate_form( PL_Config::bundler('PL_API_LISTINGS', array('create', 'args'), array('property_type')), array('method'=>'POST', 'include_submit' => false, 'wrap_form' => false, 'echo_form' => true) ); ?>
