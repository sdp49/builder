	...
	<?php endif; ?>
		...
		<ul>
			<li>
				...
				<label for="block_address">Use <b>Block Addresses</b> rather than exact addresses. Using block addresses will switch over all the addresses in your website to the nearest block, rather than exact address.</label>
			</li>
			<li>
